    ...
    return (
        <section className="py-16" style={{ backgroundColor: '#e6e2c0' }}>
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <div className="bg-white p-12 rounded-lg shadow-lg text-center max-w-4xl mx-auto">
                    <h2 className="text-3xl lg:text-4xl font-semibold font-roboto-slab text-black mb-4">
